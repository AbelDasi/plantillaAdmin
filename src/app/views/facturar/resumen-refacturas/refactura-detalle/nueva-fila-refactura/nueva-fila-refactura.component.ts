...
@Component({
  selector: 'app-nueva-fila-refactura',
  templateUrl: './nueva-fila-refactura.component.html',
  styleUrls: ['./nueva-fila-refactura.component.scss']
})
export class NuevaFilaRefacturaComponent implements OnInit {
  ...
  addFila(fNuevaFila: NgForm) {
    ...
    this.nuevaFila.refactura = this.oidRefactura;
