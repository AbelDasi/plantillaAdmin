...
export class NavigationService {
    ...
    defaultMenu: IMenuItem[] = [
        ...
        },
        {
            ...
            state: '/icons/iconsmind',
            sub: [
                { icon: 'fas fa-map-marked-alt', name: 'Ubicaciones muestra', state: '/mantenimientos/ubicaciones-muestras', type: 'link' },
                { icon: 'fas fa-eye', name: 'Observaciones', state: '/mantenimientos/observaciones', type: 'link' },
                { name: 'Clientes', type: 'dropDown',  icon: 'fas fa-user',  state: '/icons/iconsmind', sub: [
                    { icon: 'fas fa-flag', name: 'Paises', state: '/mantenimientos/paises', type: 'link' },
                
                ]},
                { name: 'Matrices', type: 'dropDown',  icon: 'fas fa-layer-group',  state: '/icons/iconsmind', sub: [
                    { icon: 'fas fa-gavel', name: 'Legislación', state: '/mantenimientos/legislacion', type: 'link' },
                
                ]},
                { name: 'Servicios', type: 'dropDown',  icon: 'fas fa-concierge-bell',  state: '/icons/iconsmind', sub: [
                    { icon: 'fas fa-map', name: 'Zonas', state: '/mantenimientos/zonas', type: 'link' },
                    { icon: 'fas fa-flask', name: 'Parametros', state: '/mantenimientos/parametros', type: 'link' },
                    { icon: 'fas fa-flask', name: 'Medios', state: '/mantenimientos/medios', type: 'link' },
                    { icon: 'fas fa-flask', name: 'Diluciones', state: '/mantenimientos/diluciones', type: 'link' },
                    { icon: 'fas fa-flask', name: 'Acronimos', state: '/mantenimientos/acronimos', type: 'link' },
                ]},
            ]
        },
        {
        ...
        /*  {
            name: 'Seguridad',
            description: 'Accede a los datos de usuarios y grupos',
            type: 'dropDown',
            icon: 'fas fa-shield-alt',
            sub: [
                { icon: 'fas fa-user-tie', name: 'Usuarios', state: '/seguridad/usuarios', type: 'link' },
                { icon: 'fas fa-users', name: 'Grupos', state: '/seguridad/grupos', type: 'link' }
            ]
        }, */
        {
            name: 'Facturar',
